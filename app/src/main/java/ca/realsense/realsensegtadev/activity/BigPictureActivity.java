...
public class BigPictureActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_big_pic) {
            ...
            Intent intent = new Intent(BigPictureActivity.this, WatchlistActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_news) {
            Intent intent = new Intent(BigPictureActivity.this, NewsActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_service_terms) {
            Intent intent = new Intent(BigPictureActivity.this, ServiceTermsActivity.class);
            startActivity(intent);
        }
