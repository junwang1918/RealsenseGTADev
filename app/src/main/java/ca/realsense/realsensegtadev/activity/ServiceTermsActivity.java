...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_big_pic) {
            Intent intent = new Intent(ServiceTermsActivity.this, BigPictureActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_watchlist) {
            Intent intent = new Intent(ServiceTermsActivity.this, WatchlistActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_news) {
            Intent intent = new Intent(ServiceTermsActivity.this, NewsActivity.class);
            startActivity(intent);
